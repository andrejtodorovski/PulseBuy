        ...
        <table class="table table-striped">
          ...
          {#each items as item}
            <tr>
              ...
              <td>TBD</td>
              <td>
                <button class="btn btn-danger btn-sm" type="button" on:click={() => removeFromWishlist(item.id)}>
                  Remove
                </button>
                <button class="btn btn-primary btn-sm" type="button" on:click={() => addToCart(item.product.id)}>Move to
                  Cart
                </button>
              </td>
            </tr>
